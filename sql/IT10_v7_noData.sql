...
) ENGINE=InnoDB02 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='AI调用日志表';
...
) ENGINE=InnoDB0 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='订单表，修复了 datata 中一个字段同时外键到 paid_content/membership_level 的冲突问题';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB0 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='项目文档表：用于存储项目内的说明文档、设计文档、会议纪要、使用手册等';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB061 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='项目附件文件表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB0 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='任务检查项表：用于把一个任务拆成多个可勾选的子步骤';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB04 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='地区信息表，支持多级行政区域划分';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-04-11 15:29:34
