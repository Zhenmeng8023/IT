...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='AI调用日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='AI消息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ai_message` VALUES (6,101,'USER',1,'你好，帮我总结一下这个项目的 AI 模块作用',5,NULL,NULL,NULL,1,1,NULL,NULL,NULL,NULL,NULL,'SUCCESS','2026-03-26 03:10:11'),(7,101,'ASSISTANT',NULL,'您好！由于您目前**未提供具体的项目背景、文档或相关上下文信息**，我无法直接总结您所指“这个项目”中 AI 模块的具体作用。为了给您提供准确且不编造的信息，请您补充以下内容：\n\n1.  **项目类型与目标**：这是一个什么类型的系统？（例如：电商后台、数据分析平台、内容生成工具、内部办公系统等）\n2.  **具体场景**：您希望 AI 在哪个环节发挥作用？（例如：用户交互、数据处理、代码辅助、自动报告生成等）\n3.  **现有资料**：如果您有项目需求文档、功能列表或代码片段，请提供关键信息。\n\n**在缺乏具体信息的情况下，IT 平台项目中 AI 模块通常具备以下几类通用作用，供您参考：**\n\n*   **智能交互与客服**：处理用户咨询、常见问题解答、意图识别及自动化回复。\n*   **数据分析与洞察**：自动挖掘数据趋势、异常检测、生成可视化报表建议。\n*   **流程自动化（RPA+AI）**：识别并自动化重复性任务，如文档分类、表单填写等。\n*   **辅助开发/创作**：代码片段生成、Bug 修复建议、技术文档编写、内容润色。\n*   **个性化推荐**：基于用户画像提供个性化的内容、产品或服务推荐。\n\n请补充更多项目细节，我将立即为您重新分析并总结 AI 模块的具体作用。',137,103,1854,1957,1,1,NULL,NULL,NULL,89958,'stop','SUCCESS','2026-03-26 03:11:41');
...
INSERT INTO `ai_model` VALUES (1,'qwen3.5:latest','OLLAMA','ollama','LOCAL_OLLAMA',NULL,'http://localhost:11434','{\"max_tokens\": 2048, \"temperature\": 0.7}',1,120000,1,0,0,0.0000,0.0000,1,'本地学习环境默认 Ollama 模型，用于 AI 聊天测试','2026-03-26 10:22:54','2026-03-26 11:09:39');
...
INSERT INTO `ai_prompt_template` VALUES (1,'chat_general','平台通用聊天模板','GENERAL_CHAT','PLATFORM',NULL,3,1,'你是 IT 平台中的 AI 助手。请使用中文回答，优先根据用户问题给出清晰、直接、分点的解释。如果问题与项目、博客、知识付费、数据库、代码有关，请尽量结合平台场景回答；如果缺少上下文，就明确说明缺少的信息，不要编造。','用户问题：{{message}}','{\"message\": {\"type\": \"string\", \"required\": true, \"description\": \"用户输入的消息内容\"}}','{\"type\": \"object\", \"description\": \"普通文本回答\"}',1,'PUBLISHED',1,'AI 模块默认通用聊天模板','2026-03-26 10:22:54','2026-03-26 10:22:54');
...
) ENGINE=InnoDB AUTO_INCREMENT=102 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='AI会话表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ai_session` VALUES (101,1,'GENERAL',NULL,NULL,'chat_general','AI 测试会话','SHORT',1,1,NULL,NULL,NULL,'{\"allowStream\": true, \"allowKnowledge\": true}','ACTIVE','2026-03-26 03:11:41','2026-03-26 10:22:54','2026-03-26 03:11:41');
...
-- Dump completed on 2026-03-27  1:09:37


INSERT INTO `knowledge_base` (`id`,`scope_type`,`project_id`,`owner_id`,`name`,`description`,`source_type`,`embedding_provider`,`embedding_model`,`chunk_strategy`,`default_top_k`,`visibility`,`status`,`doc_count`,`chunk_count`,`last_indexed_at`,`created_at`,`updated_at`) VALUES
(2,'PROJECT',NULL,3,'项目交付文档知识库','沉淀项目需求、接口约定、部署说明、测试记录等资料，供项目协作和 AI 检索使用。','PROJECT_DOC','mock-embed','bge-m3-test','PARAGRAPH',8,'TEAM','ACTIVE',0,0,NULL,'2026-03-27 09:00:00','2026-03-27 09:00:00'),
(3,'PLATFORM',NULL,1,'开发规范与 FAQ 知识库','沉淀平台开发规范、接口风格、常见排错记录、上线检查清单等公共资料。','MIXED','mock-embed','bge-m3-test','MARKDOWN',6,'PUBLIC','ACTIVE',0,0,NULL,'2026-03-27 09:02:00','2026-03-27 09:02:00'),
(4,'PERSONAL',NULL,5,'个人学习笔记知识库','用于模拟个人知识沉淀场景，包含数据库、前端、算法与 AI 学习笔记。','MANUAL','mock-embed','bge-m3-test','FIXED',5,'PRIVATE','ACTIVE',0,0,NULL,'2026-03-27 09:05:00','2026-03-27 09:05:00')
ON DUPLICATE KEY UPDATE `name`=VALUES(`name`),`description`=VALUES(`description`),`source_type`=VALUES(`source_type`),`embedding_provider`=VALUES(`embedding_provider`),`embedding_model`=VALUES(`embedding_model`),`chunk_strategy`=VALUES(`chunk_strategy`),`default_top_k`=VALUES(`default_top_k`),`visibility`=VALUES(`visibility`),`status`=VALUES(`status`),`updated_at`=VALUES(`updated_at`);

INSERT INTO `ai_session_knowledge_base` (`id`,`session_id`,`knowledge_base_id`,`priority`,`created_at`) VALUES
(1,101,1,1,'2026-03-27 09:10:00'),
(2,101,2,2,'2026-03-27 09:10:00'),
(3,101,3,3,'2026-03-27 09:10:00'),
(4,101,4,4,'2026-03-27 09:10:00')
ON DUPLICATE KEY UPDATE `priority`=VALUES(`priority`);

INSERT INTO `recommendation_rule` (`id`,`name`,`description`,`rule_type`,`weight`,`enabled`,`created_at`,`updated_at`) VALUES
(1,'内容相似度优先','根据标签、标题与摘要的相似度进行推荐','content_based',1.5,1,'2026-03-27 09:15:00','2026-03-27 09:15:00'),
(2,'协同过滤补充','根据相近用户行为补充推荐结果','collaborative',1.2,1,'2026-03-27 09:15:00','2026-03-27 09:15:00'),
(3,'热门趋势提升','对近期访问量、点赞量较高内容给予加权','hot_trending',1.1,1,'2026-03-27 09:15:00','2026-03-27 09:15:00'),
(4,'新用户冷启动','针对新注册用户使用基础规则兜底推荐','user_based',0.9,1,'2026-03-27 09:16:00','2026-03-27 09:16:00'),
(5,'项目优先曝光','提高高质量项目在综合流中的曝光机会','content_based',1.3,1,'2026-03-27 09:16:00','2026-03-27 09:16:00'),
(6,'博客知识向推荐','对学习类、教程类内容进行知识导向推荐','content_based',1.0,1,'2026-03-27 09:16:00','2026-03-27 09:16:00')
ON DUPLICATE KEY UPDATE `description`=VALUES(`description`),`rule_type`=VALUES(`rule_type`),`weight`=VALUES(`weight`),`enabled`=VALUES(`enabled`),`updated_at`=VALUES(`updated_at`);

INSERT INTO `project_template` (`id`,`name`,`description`,`category`,`creator_id`,`is_public`,`created_at`,`updated_at`) VALUES
(1,'Spring Boot 管理后台模板','适用于后台管理系统，包含基础分层、统一返回、权限占位与接口说明。','backend',3,1,'2026-03-27 09:20:00','2026-03-27 09:20:00'),
(2,'Vue3 管理端模板','适用于中后台页面，内含登录页、列表页、表单页和权限菜单示例。','frontend',3,1,'2026-03-27 09:20:00','2026-03-27 09:20:00'),
(3,'全栈项目骨架模板','适用于课程设计或小型协作项目，包含前后端目录规范与部署脚本示例。','fullstack',1,1,'2026-03-27 09:21:00','2026-03-27 09:21:00'),
(4,'API 文档模板','用于接口说明、状态码、示例请求与联调记录整理。','document',3,1,'2026-03-27 09:21:00','2026-03-27 09:21:00'),
(5,'数据库设计模板','用于表结构说明、索引设计、初始化脚本和迁移记录整理。','database',5,1,'2026-03-27 09:22:00','2026-03-27 09:22:00'),
(6,'部署交付模板','用于部署步骤、环境变量说明、回滚方案与上线检查清单。','devops',6,1,'2026-03-27 09:22:00','2026-03-27 09:22:00')
ON DUPLICATE KEY UPDATE `description`=VALUES(`description`),`category`=VALUES(`category`),`creator_id`=VALUES(`creator_id`),`is_public`=VALUES(`is_public`),`updated_at`=VALUES(`updated_at`);

INSERT INTO `project_template_file` (`id`,`template_id`,`file_name`,`file_path`,`file_size`,`mime_type`,`version`,`created_at`,`updated_at`) VALUES
(1,1,'README.md','/seed/templates/backend/README.md',4096,'text/markdown','1.0','2026-03-27 09:23:00','2026-03-27 09:23:00'),
(2,1,'openapi.yaml','/seed/templates/backend/openapi.yaml',6144,'application/yaml','1.0','2026-03-27 09:23:00','2026-03-27 09:23:00'),
(3,2,'dashboard.vue','/seed/templates/frontend/dashboard.vue',9216,'text/x-vue','1.0','2026-03-27 09:23:30','2026-03-27 09:23:30'),
(4,2,'router.js','/seed/templates/frontend/router.js',2048,'application/javascript','1.0','2026-03-27 09:23:30','2026-03-27 09:23:30'),
(5,3,'docker-compose.yml','/seed/templates/fullstack/docker-compose.yml',3072,'application/yaml','1.0','2026-03-27 09:24:00','2026-03-27 09:24:00'),
(6,3,'project-structure.md','/seed/templates/fullstack/project-structure.md',3584,'text/markdown','1.0','2026-03-27 09:24:00','2026-03-27 09:24:00'),
(7,4,'api-template.md','/seed/templates/document/api-template.md',2560,'text/markdown','1.0','2026-03-27 09:24:30','2026-03-27 09:24:30'),
(8,4,'test-cases.xlsx','/seed/templates/document/test-cases.xlsx',15360,'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet','1.0','2026-03-27 09:24:30','2026-03-27 09:24:30'),
(9,5,'schema.sql','/seed/templates/database/schema.sql',7168,'application/sql','1.0','2026-03-27 09:25:00','2026-03-27 09:25:00'),
(10,5,'migration-notes.md','/seed/templates/database/migration-notes.md',2048,'text/markdown','1.0','2026-03-27 09:25:00','2026-03-27 09:25:00'),
(11,6,'deploy-checklist.md','/seed/templates/devops/deploy-checklist.md',3072,'text/markdown','1.0','2026-03-27 09:25:30','2026-03-27 09:25:30'),
(12,6,'rollback-plan.md','/seed/templates/devops/rollback-plan.md',2816,'text/markdown','1.0','2026-03-27 09:25:30','2026-03-27 09:25:30')
ON DUPLICATE KEY UPDATE `file_name`=VALUES(`file_name`),`file_path`=VALUES(`file_path`),`file_size`=VALUES(`file_size`),`mime_type`=VALUES(`mime_type`),`version`=VALUES(`version`),`updated_at`=VALUES(`updated_at`);

INSERT INTO `coupon` (`id`,`code`,`name`,`type`,`value`,`min_amount`,`usage_limit_per_user`,`total_limit`,`start_time`,`end_time`,`is_enabled`,`created_at`,`updated_at`) VALUES
(1,'NEWUSER10','新用户满减券','amount_off',10.0,49.0,1,500,'2026-03-27 00:00:00','2026-12-31 23:59:59',1,'2026-03-27 09:30:00','2026-03-27 09:30:00'),
(2,'SPRING85','春季85折券','discount',8.5,0.0,2,300,'2026-03-27 00:00:00','2026-06-30 23:59:59',1,'2026-03-27 09:30:00','2026-03-27 09:30:00'),
(3,'DOC20','文档专区20元券','amount_off',20.0,99.0,1,200,'2026-03-27 00:00:00','2026-08-31 23:59:59',1,'2026-03-27 09:31:00','2026-03-27 09:31:00'),
(4,'MEMBER88','会员88折券','discount',8.8,29.0,1,200,'2026-03-27 00:00:00','2026-09-30 23:59:59',1,'2026-03-27 09:31:00','2026-03-27 09:31:00'),
(5,'PROJECT30','项目资料30元券','amount_off',30.0,199.0,1,120,'2026-03-27 00:00:00','2026-10-31 23:59:59',1,'2026-03-27 09:32:00','2026-03-27 09:32:00'),
(6,'LEARN95','学习专区95折券','discount',9.5,0.0,5,1000,'2026-03-27 00:00:00','2027-03-31 23:59:59',1,'2026-03-27 09:32:00','2026-03-27 09:32:00'),
(7,'VIP50','高级会员立减券','amount_off',50.0,299.0,1,80,'2026-03-27 00:00:00','2026-11-30 23:59:59',1,'2026-03-27 09:33:00','2026-03-27 09:33:00'),
(8,'RETURN15','回流用户15元券','amount_off',15.0,59.0,1,260,'2026-03-27 00:00:00','2026-07-31 23:59:59',1,'2026-03-27 09:33:00','2026-03-27 09:33:00')
ON DUPLICATE KEY UPDATE `name`=VALUES(`name`),`type`=VALUES(`type`),`value`=VALUES(`value`),`min_amount`=VALUES(`min_amount`),`usage_limit_per_user`=VALUES(`usage_limit_per_user`),`total_limit`=VALUES(`total_limit`),`start_time`=VALUES(`start_time`),`end_time`=VALUES(`end_time`),`is_enabled`=VALUES(`is_enabled`),`updated_at`=VALUES(`updated_at`);

ALTER TABLE `knowledge_base` AUTO_INCREMENT = 5;

ALTER TABLE `ai_session_knowledge_base` AUTO_INCREMENT = 5;

ALTER TABLE `recommendation_rule` AUTO_INCREMENT = 7;

ALTER TABLE `project_template` AUTO_INCREMENT = 7;

ALTER TABLE `project_template_file` AUTO_INCREMENT = 13;

ALTER TABLE `coupon` AUTO_INCREMENT = 9;
