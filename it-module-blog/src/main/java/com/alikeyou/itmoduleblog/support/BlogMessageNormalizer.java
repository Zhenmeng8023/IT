package com.alikeyou.itmoduleblog.support;
...
public final class BlogMessageNormalizer {
    ...
    private static final List<String> INVALID_PARAM_KEYWORDS = List.of(
            "不能为空", "必须", "无效", "格式错误", "列表不能为空", "仅支持", "不合法"
    );
    private static final List<String> AUTH_KEYWORDS = List.of("未登录", "登录");
    private static final List<String> FORBIDDEN_KEYWORDS = List.of("无权限", "权限", "仅作者", "仅本人", "管理员");
    private static final List<String> NOT_FOUND_KEYWORDS = List.of("不存在", "不可访问");

    private BlogMessageNormalizer() {
    }
