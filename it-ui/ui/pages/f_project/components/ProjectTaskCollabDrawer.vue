    ...
    <div v-if="taskData" class="task-collab-drawer-shell">
      <div class="task-collab-hero">
        <div class="task-collab-hero-main">
          ...
          <div class="task-collab-title-row">
            ...
            <div class="task-collab-title-tags">
              <el-tag size="mini" effect="plain" :type="getTaskPriorityType(taskData.priority)">{{ getTaskPriorityText(taskData.priority) }}</el-tag>
              <el-tag size="mini" :type="getTaskStatusType(taskData.status)">{{ getTaskStatusText(taskData.status) }}</el-tag>
              <el-tag v-if="isTaskOverdue(taskData)" size="mini" type="danger">已逾期</el-tag>
            </div>
          </div>
          <div class="task-collab-desc">{{ taskData.description || '这条任务还没有补充详细描述，可以先在任务管理页补充背景、目标和验收标准。' }}</div>
          <div class="task-collab-meta-grid">
            ...
            <div class="task-collab-meta-card">
              ...
              <div class="task-collab-meta-value">{{ formatTaskShortTime(taskData.createdAt) }}</div>
            </div>
            <div class="task-collab-meta-card">
        ...
        <div class="task-collab-side-box">
          <div class="task-collab-side-title">快捷跳转</div>
