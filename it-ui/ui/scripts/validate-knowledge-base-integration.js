...
function testRoutes() {
  ...
  assertIncludes(routeSource, "redirect: to => ({ path: '/user/ai/knowledge', query: to.query, hash: to.hash })", 'legacy personal route redirects to new user ai knowledge path')
  ...
  assertIncludes(routeSource, "path: '/projectmanage'", 'front project knowledge route redirects to project manage')
  assertIncludes(routeSource, "query: { ...(to.query || {}), tab: 'knowledge' }", 'front project knowledge route pins knowledge tab')
  assertIncludes(routeSource, "permissions: ['view:front:project:manage']", 'front project knowledge route uses project manage permission')
